...
This repository shows you how you can amend the requests in JMeter to send the correct token on each form POST. It implements the advice in this [stack overflow article](https://stackoverflow.com/questions/26482314/jmeter-token-value-extraction).
